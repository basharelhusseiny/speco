...
const labelClass =
  "mb-2 block font-heading text-xs font-semibold uppercase tracking-[0.08em] text-body-dark";

export default function Contact() {
  usePageMeta({
    title:
      "Contact SPECO Building Technology | Get a Quote | Juba, South Sudan",
    description:
  ...
  const validateField = (
    ...
    if (key === "message" && !value.trim())
      return "Tell us a little about your project or inquiry.";
    return undefined;
  };
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-black/10 to-transparent"
          aria-hidden="true"
        />
        ...
        <div className="container-x">
          ...
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <h2
                id="contact-details"
                className="h-section mt-4 max-w-2xl text-body-dark"
              >
                Reach our team in{" "}
                <span className="text-speco-dark">Juba, South Sudan.</span>
              </h2>
            </div>
            <p className="max-w-md text-sm leading-relaxed text-mutedlight md:text-right">
              Whether you are an engineer, developer, contractor, or government
              agency, our factory and project team is ready to respond.
            </p>
          </div>
          ...
          <div className="mt-14 grid gap-10 lg:grid-cols-12 lg:gap-14">
            ...
            <div className="min-w-0 lg:col-span-5">
              <div className="space-y-4">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2">
                          <p className="min-w-0 truncate font-heading text-[11px] font-semibold uppercase tracking-[0.12em] text-mutedlight">
                            {d.label}
                          </p>
                          <span className="inline-flex shrink-0 items-center gap-1 font-heading text-[11px] font-medium text-speco opacity-0 transition-opacity duration-200 group-hover:opacity-100">
                            {d.action}
                            <ArrowUpRight
                              className="h-3 w-3"
                              aria-hidden="true"
                        ...
                        <p className="mt-0.5 text-xs text-mutedlight">
                          {d.sub}
                        </p>
                      </div>
                    </a>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-emerald-500/10 px-2.5 py-0.5 font-heading text-[10px] font-semibold uppercase tracking-wider text-emerald-600">
                        ...
                        {contact.hours.map((h) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span
                                className={`font-semibold ${isClosed ? "text-speco-dark" : "text-body-dark"}`}
                              >
                                {time}
                              </span>
                            </div>
                ...
                <div className="relative overflow-hidden rounded-sm border border-black/[0.08] bg-surface-light">
                  <div className="flex items-center justify-between gap-2 border-b border-black/[0.06] bg-white px-4 py-2.5">
                    <div className="flex min-w-0 items-center gap-2">
                      <span className="h-2 w-2 shrink-0 rounded-full bg-speco" />
                      <span className="truncate font-heading text-xs font-semibold text-body-dark">
                        Factory Location
                      </span>
                    </div>
                    <span className="shrink-0 font-mono text-[11px] text-mutedlight">
                      Gombo Soug, Juba
                    </span>
                  </div>
                  <iframe
            ...
            <div className="min-w-0 lg:col-span-7">
              <div className="relative overflow-clip rounded-sm border border-black/[0.08] bg-surface-light p-5 shadow-xl shadow-black/[0.03] sm:p-8 md:p-10">
                ...
                {status === "sent" ? (
                  ...
                  >
                    ...
                    <p className="mt-3 max-w-md text-base leading-[1.7] text-mutedlight">
                      ...
                      . Your inquiry has been forwarded directly to our Juba
                      sales and technical engineering team.
                    </p>
                    <div className="mt-6 rounded-sm border border-black/[0.06] bg-white p-4 text-xs text-mutedlight">
                      ...
                      <p className="mt-1">
                        Urgent inquiry? Call directly at{" "}
                        <a
                          href={contact.phoneHref}
                          className="font-semibold text-speco-dark underline"
                        >
                  ...
                  <div>
                    ...
                    <div className="mb-8">
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-mutedlight">
                        Fill out the details below. For blueprints or technical
                        BOQ documents, you can also share them via WhatsApp.
                      </p>
                    </div>
                    ...
                    >
                        ...
                        <div>
                          ...
                          {errors.name && (
                            <p
                              id="name-error"
                              role="alert"
                              className="mt-1.5 text-xs font-medium text-speco-dark"
                            >
                              {errors.name}
                            </p>
                          )}
                      ...
                      <div className="mt-5">
                        <div className="flex flex-wrap items-center justify-between gap-x-2 gap-y-0">
                          ...
                          <span className="mb-2 shrink-0 font-heading text-[10px] uppercase tracking-wider text-mutedlight">
                      ...
                      {/* Assurance Badges */}
                      <div className="mt-8 grid grid-cols-3 gap-x-2 gap-y-3 border-t border-black/[0.06] pt-6">
                        <div className="flex items-center gap-2 text-xs text-body-dark/80">
                          <ShieldCheck
                            className="h-4 w-4 shrink-0 text-speco"
                            aria-hidden="true"
                          />
      ...
      <Band
        ...
        ariaLabelledby="contact-commitments"
      >
        <div className="container-x">
          <div className="grid gap-8 md:grid-cols-3">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-body-ondark/65">
                  Send architectural plans, CAD files, or BOQs directly to our
                  engineers for rapid project costing.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-body-ondark/65">
                  Factory-direct dispatch across Juba and onward logistics
                  coordination to all South Sudan states.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-body-ondark/65">
                  Inspect raw EPS panels, sandwich wall cuts, and completed
                  prefab structures in person at Gombo Soug.
                </p>
              </div>
            </div>
          </div>
