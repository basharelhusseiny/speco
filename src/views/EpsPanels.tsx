...
const benefits = [
  {
    ...
    icon: ThermometerSun,
    copy: "High-density EPS core provides excellent thermal performance, reducing energy costs for heating and cooling.",
  },
  {
    title: "Soundproofing",
    icon: Volume2,
    copy: "Dense construction naturally dampens sound transmission between spaces.",
  },
  {
    title: "Fire Resistance",
    icon: Flame,
    copy: "Concrete plaster coating provides significant fire resistance ratings.",
  },
  {
    title: "Speed of Installation",
    icon: Clock,
    copy: "Large panel sizes mean faster coverage and reduced labour time.",
  },
  {
    title: "Structural Integrity",
    icon: Zap,
    copy: "Steel mesh reinforcement creates a monolithic structure when plastered.",
  },
  {
    title: "Cost Effective",
    icon: DollarSign,
    copy: "Reduced construction time and labour costs compared to traditional methods.",
  },
];
...
const environmental = [
  {
    ...
    icon: Zap,
    copy: "Improves building performance, making structures cooler in hot climates and warmer in cold weather.",
  },
  {
    title: "Sustainable",
    icon: Recycle,
    copy: "Lower embodied energy than traditional blocks; reduces site waste and carbon footprint.",
  },
  {
    title: "Locally Produced",
    icon: MapPin,
    copy: "Cuts down on transport emissions and supports the local economy.",
  },
  {
    title: "Versatile",
    icon: Building2,
    copy: "Suitable for homes, schools, offices, and more.",
  },
];
...
export default function EpsPanels() {
  usePageMeta({
    title:
      "EPS 3D Wall Panels | Expanded Polystyrene Panels | SPECO Building Technology",
    description:
    ...
    keywords:
      "EPS panels, expanded polystyrene panels, 3D wall panels, insulated panels, thermal insulation panels, lightweight construction panels",
  });
  ...
  return (
    <>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              ...
              <p className="mt-5 text-base leading-[1.7] text-mutedlight">
                EPS stands for Expanded Polystyrene, a high-quality, lightweight
                foam material used in modern construction worldwide. It is
                recognised for its strength, versatility, and outstanding
                insulation properties.{" "}
                <strong className="text-body-dark">
                  SPECO is the first company to manufacture and apply it in
                  South Sudan.
                </strong>
              </p>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                {[
                  ...
                  <div
                    key={s.label}
                    className="rounded-sm border border-black/[0.07] bg-surface-light p-4"
                  >
                    <p className="font-heading text-2xl font-bold text-speco-dark">
                      {s.value}
                    </p>
                    <p className="mt-1 font-heading text-[10px] font-semibold uppercase tracking-[0.1em] text-mutedlight">
                      {s.label}
                    </p>
                  </div>
                ))}
      ...
      <Band
        ...
        ariaLabelledby="how-made"
      >
        <div
          className="pointer-events-none absolute -left-20 top-0 h-[400px] w-[400px] rounded-full bg-speco/[0.06] blur-[100px]"
          aria-hidden="true"
        />
        <div
              ...
              <ol className="mt-10 space-y-0 border-t border-white/[0.07]">
                {madeSteps.map((s, i) => (
                  ...
                  >
                    ...
                    <span className="text-base leading-[1.65] text-body-ondark/85">
                      {s}
                    </span>
                  </li>
                ))}
      ...
      <Band tone="light" ariaLabelledby="quality">
        <div className="container-x py-10 md:py-12">
          <div className="relative overflow-hidden rounded-sm border border-speco/20 bg-speco/[0.04] px-8 py-7 text-center">
            ...
            <p
              id="quality"
              className="mx-auto max-w-3xl font-heading text-lg font-semibold leading-[1.5] text-body-dark md:text-xl"
            >
              Every panel is manufactured under strict quality control for
      ...
      <Band
        tone="light"
        className="section-pad border-t border-black/[0.08]"
        ariaLabelledby="product-desc"
      >
        <div className="container-x">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <div className="mt-5 space-y-4 text-base leading-[1.7] text-mutedlight">
                <p>
                  Our Expanded Polystyrene (EPS) 3D Wall Panels represent a
                  revolutionary approach to modern construction. These
                  lightweight yet incredibly strong panels are composed of a
                  core of high-density EPS foam, reinforced with a steel mesh on
                  both sides. Once installed and plastered with concrete, they
                  form a monolithic, load-bearing structure that offers
                  exceptional thermal insulation, soundproofing, and fire
                  resistance.
                </p>
                <p>
                  They are ideal for rapid construction of residential,
                  commercial, and industrial buildings, significantly reducing
              ...
              <div className="mt-8 flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tag}
                    className="inline-flex items-center gap-1.5 rounded-xs border border-black/[0.08] bg-surface-light px-3 py-1 font-heading text-xs font-semibold uppercase tracking-[0.08em] text-body-dark"
                  >
      ...
      <Band
        tone="dark"
        className="section-pad relative overflow-hidden"
        ariaLabelledby="specs"
      >
        <div
          className="pointer-events-none absolute -right-20 -top-20 h-[350px] w-[350px] rounded-full bg-speco/[0.07] blur-[90px]"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent"
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <h2 id="specs" className="h-section mt-5 text-white">
                Panel <span className="text-speco">specifications.</span>
              </h2>
              <p className="mt-4 text-sm leading-relaxed text-body-ondark/65">
                All panels manufactured to international standards at the SPECO
                factory in Juba. Custom dimensions available on request.
              </p>
              <div className="mt-8">
                <SpecTable
                  rows={specs}
                  tone="dark"
                  label="EPS 3D wall panel specifications"
                />
              </div>
            </div>
            <div className="relative overflow-hidden rounded-sm border border-white/[0.08]">
        ...
        <div className="container-x">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <h2
                id="benefits"
                className="h-section mt-5 max-w-xl text-body-dark"
              >
                Why builders{" "}
            ...
            <p className="max-w-sm text-sm leading-relaxed text-mutedlight md:text-right">
              From thermal performance to structural strength — EPS delivers
              where traditional blockwork cannot.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <span className="font-heading text-xs font-semibold tabular-nums text-speco/50">
                      {String(i + 1).padStart(2, "0")}
                    </span>
                  </div>
                  ...
                  <p className="mt-2 text-sm leading-[1.65] text-mutedlight">
                    {b.copy}
                  </p>
                </div>
              );
      ...
      <Band
        tone="dark"
        className="section-pad relative overflow-hidden"
        ariaLabelledby="environmental"
      >
        <div
          className="pointer-events-none absolute -left-20 bottom-0 h-[400px] w-[400px] rounded-full bg-speco/[0.07] blur-[100px]"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent"
              ...
              <div className="mt-10 grid gap-5 sm:grid-cols-2">
                {environmental.map((e) => {
                  ...
                  return (
                    <div
                      key={e.title}
                      className="group rounded-sm border border-white/[0.07] bg-surface-dark p-5 transition-colors hover:border-speco/30"
                    >
                      ...
                      <p className="mt-2 text-sm leading-[1.65] text-body-ondark/65">
                        {e.copy}
                      </p>
                    </div>
                  );
      ...
      <Band tone="light" className="section-pad" ariaLabelledby="applications">
        <div className="container-x">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-mutedlight md:text-right">
              Suitable for residential homes, apartments, commercial offices,
              industrial facilities, schools, and healthcare facilities.
            </p>
          </div>
          ...
          <div className="mt-14 grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
            <ul className="space-y-0 border-t border-black/[0.08]">
              {applications.map((a, i) => (
                ...
                >
                  ...
                  <ArrowUpRight
                    className="h-4 w-4 shrink-0 text-transparent transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-speco"
                    aria-hidden="true"
                  />
                </li>
              ))}
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <figure
                  key={im.path}
                  className="group overflow-hidden rounded-sm border border-black/[0.08] bg-surface-light transition-all hover:border-speco/30"
                >
                  ...
                  <figcaption className="px-4 py-3 text-xs text-mutedlight">
                    {im.caption}
                  </figcaption>
                </figure>
              ))}
      ...
      <Band
        tone="dark"
        className="section-pad relative overflow-hidden"
        ariaLabelledby="case-study"
      >
        <div
          className="pointer-events-none absolute -right-20 top-0 h-[500px] w-[500px] rounded-full bg-speco/[0.06] blur-[120px]"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent"
        ...
        <div className="container-x relative z-10">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              >
                H Brothers <span className="text-speco">G+6 Tower.</span>
              </h2>
            </div>
            <p className="max-w-sm text-sm leading-relaxed text-body-ondark/60 md:text-right">
              A G+6 residential and commercial tower — concrete foundation with
              EPS slabs, walls, and staircases throughout. Six storeys answer
              the load-bearing question better than any specification.
            </p>
          </div>
            ...
            {caseStudySequence.map((im, i) => (
              ...
              >
                ...
                <figure className="overflow-hidden rounded-sm border border-white/[0.08] bg-surface-dark transition-all duration-300 group-hover:border-speco/40">
                  <div
                    className={`img-frame ${im.orientation === "portrait" ? "aspect-[3/4] md:aspect-[16/9]" : "aspect-[16/9]"} relative overflow-hidden`}
                  >
                    <ResponsiveImage image={im} />
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 id="install-proof" className="h-section mt-5 text-body-dark">
                Days, <span className="text-speco-dark">not months.</span>
              </h2>
              <p className="mt-5 text-base leading-[1.7] text-mutedlight">
                Panels arrive ready to place. A small SPECO crew sets, ties, and
                plasters them in sequence — no blockwork, no formwork delays, no
                heavy plant for most walls.
              </p>
        ...
        <div className="container-x">
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 lg:grid-cols-4">
            {[
              ...
              <figure
                key={im.path}
                className="group overflow-hidden rounded-sm border border-white/[0.08] bg-surface-dark transition-all hover:border-speco/40"
              >
                <div
                  className={`img-frame relative ${im.orientation === "portrait" ? "aspect-[3/4]" : "aspect-[3/2]"} overflow-hidden`}
                >
                  <ResponsiveImage image={im} />
          ...
          <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-7">
              ...
              <p className="mt-5 text-base leading-[1.7] text-body-ondark/80 md:text-lg">
                Contact our technical sales team for a free BOQ review and
                project-specific quote. Factory direct from Juba.
              </p>
