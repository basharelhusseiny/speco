...
export default function Gallery() {
  ...
  const visible = useMemo(
    () =>
      filter === "all"
        ? ALL_IMAGES
        : ALL_IMAGES.filter((i) => i.category === filter),
    [filter],
  );
  ...
  return (
    <>
      ...
      <Band
        ...
        ariaLabelledby="featured-case"
      >
        <div
          className="pointer-events-none absolute -right-20 top-0 h-[450px] w-[450px] rounded-full bg-speco/[0.06] blur-[120px]"
          aria-hidden="true"
        />
        <div
        ...
        <div className="container-x relative z-10">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              >
                H Brothers <span className="text-speco">G+6 Tower</span>, stage
                by stage.
              </h2>
            </div>
            <p className="max-w-sm text-sm leading-relaxed text-body-ondark/60 md:text-right">
              Panels installed, plaster and services, interior fit-out, facade,
              completed — a full build narrative in eleven frames.
            </p>
          </div>
              ...
              <li key={im.path}>
                <button
                  ...
                  onClick={(e) => {
                    setFilter("all");
                    openLightbox(
                      ALL_IMAGES.findIndex((a) => a.path === im.path),
                      e.currentTarget,
                    );
                  }}
                ...
                >
                  ...
                  <div className="grid items-center gap-0 md:grid-cols-[80px_1fr]">
                    ...
                    {/* Image */}
                    <div
                      className={`img-frame relative overflow-hidden ${im.orientation === "portrait" ? "aspect-[3/4] md:aspect-[21/9]" : "aspect-[16/9]"}`}
                    >
                  ...
                  <div className="flex items-center justify-between border-t border-white/[0.06] px-5 py-3">
                    <span className="text-sm text-body-ondark/60 transition-colors group-hover:text-body-ondark/80">
                      {im.caption}
                    </span>
        ...
        <div className="container-x">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-mutedlight md:text-right">
              Filter by category to find EPS projects, prefab builds, or product
              shots.
            </p>
          </div>
          ...
          <div className="mt-10 gap-4 sm:columns-2 lg:columns-3">
            {visible.map((im, i) => (
              ...
              >
                <div
                  className={`img-frame relative overflow-hidden ${im.orientation === "portrait" ? "aspect-[3/4]" : im.orientation === "wide" ? "aspect-[16/9]" : "aspect-[3/2]"}`}
                >
                  <ResponsiveImage image={im} />
                  {/* Hover overlay */}
                ...
                <span className="block border-t border-black/[0.06] px-4 py-3 text-xs text-mutedlight transition-colors group-hover:text-body-dark">
                  {im.caption}
                </span>
              </button>
            ))}
        ...
        <div className="container-x relative z-10">
          <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-8">
              ...
              <h2
                id="gallery-cta"
                className="h-section mt-5 max-w-xl text-white"
              >
              ...
              <p className="mt-5 max-w-xl text-base leading-[1.7] text-body-ondark/80 md:text-lg">
                Every project in this gallery started with a quote. Talk to our
                team and let&apos;s plan yours — factory direct from Juba.
              </p>
